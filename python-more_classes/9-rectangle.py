...
class Rectangle:
    ...
    def __repr__(self):
        """
        Este metodo regresa una repesentación del rectangulo

        Returns:
            String:Cadena que representa el rectangulo
        """
    ...
    def square(cls, size=0):
        """
        Este metodo crea una nueva instancia de la clase rectangulo
        Args:
            size(int): Este valor se asignará como parametos
            para nuestra instancia
        """
